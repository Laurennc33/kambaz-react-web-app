export default function Lab1() {
    ...
    <div>
      ...
      <div id="wd-lists">
        ...
        <li>Mix dry ingredients.</li>
            <li>Start by chopping oninos and celery.</li>
            <li>Boil any type of box of noodles.</li>
            <li>Chop up small pieces of bread then put it inot a machine to make it breadcrumbs.</li>
            <li>Mix cream of celery and tuna into a saucepan until evenly mixed.</li>
            <li>Once noodles are ready put into a put to bake and mix everything in.</li>
            <li>Spread your choice of chesse on top</li>
            <li>Put into oven for 30 minutes. </li>
            <li>Take it out and enjoy!</li>
        </ol>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="images/lewis-ferrari.jpg" height="200px" />
    </div>
    ...
    <form id="wd-text-fields">
        ...
        <input placeholder="johndoe" id="wd-text-fields-username" /> <br />
        ...
        <input type="text" placeholder="Doe"
            ...
            <textarea id="wd-textarea" cols={30} rows={10}>Lorem Ipsum is simply dummy text 
